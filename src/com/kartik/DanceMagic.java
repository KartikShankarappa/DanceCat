...
public class DanceMagic {
    ...
    private String getMoveLocation(int sequence) {
        return String.format("src/main/resources/cat-0%s%d.txt", (sequence < 10 ? "0" : ""), sequence);
    }
    ...
    private void printWin() {
        printMessage("src/main/resources/cat-win.txt", "6");
    }

    private void printLose() {
        printMessage("src/main/resources/cat-lose.txt", "3");
    }

    private void printTie() {
        printMessage("src/main/resources/cat-tie.txt", "7");
    }

    private void printError() {
        printMessage("src/main/resources/cat-error.txt", "1");
    }
